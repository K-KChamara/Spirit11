    ...
    const chatSession = model.startChat({
      ...
      history: [
        ...
        },
        {
          role: "model",
          parts: [
            {text: "Thanks, Kasun! How can I help you with your Spirit11 Fantasy Cricket questions today? Do you have any questions about player selection, match strategies, or the league rules? Let me know what's on your mind!\n"},
          ],
        },
      ],
    });
